...
1. Символы $a_i$ алфавита $A$ выписывают по убыванию вероятностей $p_i$.
2. Для каждого символа $a_i$ вычисляется его количество информации, округлённое вверх: $l_i = \lceil -\log_2 p_i \rceil$.
3. В качестве кода символа $a_i$ используются $l_i$ первых цифр после запятой из двоичного представления кумулятивной вероятности $p_1 + \dots + p_i$.
