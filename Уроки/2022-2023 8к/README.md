...
- Напишите программу, которая:
  ...
  - для заданных чисел $a$ и $b$ (эти коэффициенты нужно спросить у пользователя) вычисляет среднее значение величины $d = |z - (a\cdot x + b\cdot y)|$ для каждой строки таблицы;
