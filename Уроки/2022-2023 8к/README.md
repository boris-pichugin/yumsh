...
3. Напишите функцию сложения двух целых чисел в позиционной системе счисления с данным основанием. В функцию каждое слагаемое передаётся в виде строки, состоящей из цифр числа. Результат также следует представить в виде строки, состоящей из цифр числа.
...
4. (*) Напишите функцию умножения двух целых чисел в позиционной системе счисления с данным основанием. В функцию каждое слагаемое передаётся в виде строки, состоящей из цифр числа. Результат также следует представить в виде строки, состоящей из цифр числа.
