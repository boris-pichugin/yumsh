...
- [Циклы](#циклы)
  ...
  - [05. Решение уравнения $a\,x \equiv_m b$](#05-решение-уравнения-ax-equiv_m-b)
  - [06. Вычисление числа pi](#06-вычисление-числа-pi)
  - [07. Решение диофантового уравнения $a\,x + b\,y = c$](#07-решение-диофантового-уравнения-ax--by--c)
...
### 05. Решение уравнения $a\,x \equiv_m b$

Спросить у пользователя целые числа $a$, $b$ и натуральное $m$. Вывести решение уравнения $a\,x \equiv_m b$.
...
$$1+\frac{1}{2^2}+\frac{1}{3^2}+\cdots=\sum_{k=1}^\infty\frac{1}{k^2}=\frac{\pi^2}{6}$$

2. Используя формулу для суммы ряда Лейбница:

$$1-\frac{1}{3}+\frac{1}{5}-\frac{1}{7}+\cdots=\sum_{k=0}^\infty\frac{(-1)^k}{2k+1}=\frac{\pi}{4}$$

3. Используя формулу для произведения Валлиса:

$$\frac{2^2}{1\cdot3}\cdot\frac{4^2}{3\cdot5}\cdot\frac{6^2}{5\cdot7}\cdots=\prod_{k=1}^\infty\frac{(2k)^2}{(2k-1)(2k+1)}=\frac{\pi}{2}$$

4. Используя формулу для произведения Виета:

$$\frac{2}{\sqrt{2}}\cdot\frac{2}{\sqrt{2+\sqrt{2}}}\cdot\frac{2}{\sqrt{2+\sqrt{2+\sqrt{2}}}}\cdot\frac{2}{\sqrt{2+\sqrt{2+\sqrt{2+\sqrt{2}}}}}\cdots=\frac{\pi}{2}$$

5. Используя телескопическую формулу Броункера:

$$2+\cfrac{1^2}{2+\cfrac{3^2}{2+\cfrac{5^2}{2+\cfrac{7^2}{2+\cdots}}}}=1+\frac{4}{\pi}$$

Чтобы обрезать формулу на шаге с номером *n* надо последнюю дробь вида

$$2+\cfrac{(2n+1)^2}{2+\cdots}$$
...
$$F_1=1,\quad%20F_2=1,\quad%20F_n=F_{n-2}+F_{n-1},\enskip%20n=3,4,\dots$$
...
### 16. Быстрое возведение в степень
...
### 19. Перевод римской записи в арабскую
